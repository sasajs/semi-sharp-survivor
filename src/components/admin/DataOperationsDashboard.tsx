...
import { DataQualityLogManager } from "./DataQualityLogManager";
import {
  LayoutDashboard,
  Brain,
  Users,
        ...
        <div className="md:col-span-3 space-y-6">
          <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm relative overflow-hidden">
            ...
            <div className="flex items-start justify-between gap-4">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <span className="text-[9px] font-black text-indigo-600 uppercase tracking-widest font-mono bg-indigo-50 px-2 py-0.5 rounded-full">
                      {["team-aliases", "schedule-imports", "import-history", "data-quality"].includes(activeSubTab) ? "EPIC 2 OPERATIONAL" : "Epic 2 Blueprint"}
                    </span>
              ...
              {["team-aliases", "schedule-imports", "import-history", "data-quality"].includes(activeSubTab) ? (
            ...
            <div className="mt-8">
              {activeSubTab === "team-aliases" && <TeamAliasesManager />}
              {activeSubTab === "schedule-imports" && <ScheduleImportManager />}
              {activeSubTab === "import-history" && <ImportHistoryManager />}
              {activeSubTab === "data-quality" && <DataQualityLogManager />}
                ...
                <div className="space-y-6">
                  ...
                  {activeSubTab === "dashboard" && (
                    <div className="bg-slate-950 text-slate-100 rounded-xl p-4 font-mono text-[11px] leading-relaxed overflow-x-auto shadow-inner border border-slate-800">
                      ...
                      <div className="pl-4 text-slate-400 flex flex-row">],</div>
