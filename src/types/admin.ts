...
export interface ClientRepositoryValidationResult {
...
export interface ClientMigrationValidationResult {
  status: "HEALTHY" | "WARNING" | "FAILED";
  migrations: {
    version: string;
    description: string;
...
export interface ClientConnectionValidationResult {
  status: "HEALTHY" | "WARNING" | "FAILED";
...
export interface ClientPostgresValidationResult {
  status: "HEALTHY" | "WARNING" | "FAILED";
  environmentValid: boolean;
  errorMessage: string | null;
}

export interface ClientSystemReadinessResult {
  overallStatus: "HEALTHY" | "WARNING" | "FAILED";
  repositoryValidation: ClientRepositoryValidationResult;
  migrationValidation: ClientMigrationValidationResult;
  connectionValidation: ClientConnectionValidationResult;
  environmentValidation: ClientPostgresValidationResult;
  warnings: string[];
