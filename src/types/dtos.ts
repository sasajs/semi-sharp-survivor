...
export type WorkflowStatusDTO = 'PENDING' | 'RUNNING' | 'SUCCEEDED' | 'FAILED' | 'PARTIAL_FAILED' | 'SKIPPED';
export type WorkflowTypeDTO = 'FULL_WEEKLY_RESEARCH' | 'IMPORT_ONLY' | 'FEATURE_REFRESH_ONLY' | 'RECOMMENDATION_ONLY' | 'SIMULATION_ONLY' | 'REPORT_ONLY' | 'EXPORT_ONLY';
export type TriggerSourceDTO = 'manual' | 'cron' | 'system';
...
export interface WorkflowRunDTO {
  ...
  status: WorkflowStatusDTO;
  requestedBy: string;
  triggerSource: TriggerSourceDTO;
...
export interface WorkflowAuditMetadataDTO {
...
export interface WorkflowExecutionRequestDTO {
  workflowType: WorkflowTypeDTO;
