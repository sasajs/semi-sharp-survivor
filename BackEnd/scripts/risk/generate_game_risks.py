...
def main():
    ...
    with get_connection() as conn:
        with conn.cursor() as cur:
            ...
            for game in games:
                ...
                # ---------------------------------
                # V3 Favorite Spread Risk
                # ---------------------------------

                favorite_spread = abs(game["projected_spread"])

                if favorite_spread <= 3:
                    add_risk(
                        cur,
                        game,
                        favorite_id,
                        "SMALL_FAVORITE_RISK",
                        f"Favorite is only {favorite_spread:.1f} points."
                    )
                    inserted += 1
                    ...
                    add_risk(
                        ...
                        game,
                        favorite_id,
                        "MODERATE_FAVORITE_RISK",
                        f"Favorite spread is {favorite_spread:.1f} points."
                    )
                    inserted += 1

                elif favorite_spread <= 14:
                    add_risk(
                        cur,
                        game,
                        favorite_id,
    ...
    print(f"Generated V3 risk factors: {inserted}")
